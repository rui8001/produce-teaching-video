...
[![Release](https://img.shields.io/badge/release-v0.1.1-2563eb.svg)](./CHANGELOG.md)
...
| 示例 | 证明什么 |
| --- | --- |
| [为什么不是每个月都有日食](./examples/solar-eclipse/README.md) | 用来源核对、视角转换和理想化模型解释物理概念 |
| [安全处理一个 Git 合并冲突](./examples/git-merge-conflict/README.md) | 用可重复终端证据、状态比较和人工决策教授操作技能 |

两个示例都包含学习简报、来源台账、纯口播稿、表演稿、语义视觉计划、自绘示意图、生产状态和质检记录，并诚实标出仍需真实音频才能完成的阶段。它们不包含作者的真实生产项目、私人代码或素材。
